          ...
          <div className='flex justify-between p-4'>
            ...
            <div className='flex flex-col'>
              ...
              <div className='icons flex justify-between mt-3'>
                <a href="https://www.google.co.in/" style={{textDecoration:'none',color:'white'}} target='_blank'><i class="fa-brands fa-twitter"></i></a>
                <a href="https://www.google.co.in/" style={{textDecoration:'none',color:'white'}} target='_blank'><i class="fa-brands fa-linkedin"></i></a>
                <a href="https://www.google.co.in/" style={{textDecoration:'none',color:'white'}} target='_blank'><i class="fa-brands fa-facebook"></i></a>
                <a href="https://www.google.co.in/" style={{textDecoration:'none',color:'white'}} target='_blank'><i class="fa-brands fa-instagram"></i></a>
                <a href="https://www.google.co.in/" style={{textDecoration:'none',color:'white'}} target='_blank'><i class="fa-brands fa-github"></i></a>
                <a href="https://www.google.co.in/" style={{textDecoration:'none',color:'white'}} target='_blank'><i class="fa-solid fa-phone"></i></a>


              </div>
            </div>
          </div>
          <p className='text-center mt-3 text-white'>Copyright &copy; May 2024 Batch,E-cart.Build with React.</p>
    </div>
  )
}
